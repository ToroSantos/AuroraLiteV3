...
class DetectorComponentesAvanzado:
    ...
    def _init_registro_completo(self) -> Dict[str, ComponenteAurora]:
        return {
            ...
            "emotion_style_profiles": ComponenteAurora("emotion_style_profiles", TipoComponente.STYLE_PROFILE, "emotion_style_profiles", "GestorEmotionStyleUnificadoV7", dependencias=[], fallback_disponible=True, nivel_prioridad=3),
